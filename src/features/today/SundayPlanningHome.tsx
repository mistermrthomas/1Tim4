...
function SetupRow({
  ...
  return (
    <li
      className={`sunday-setup__item sunday-setup__item--${item.status}`}
    >
      ...
      <div className="sunday-setup__body">
        ...
        <div className="sunday-setup__actions">
          <Link className="path-btn path-btn--primary" to={weekPlanPath(weekStart, item.step)}>
            {item.primaryAction}
          </Link>
          {item.secondaryAction ? (
            <Link className="path-btn path-btn--ghost" to={weekPlanPath(weekStart, item.step)}>
              {item.secondaryAction}
            </Link>
          ) : null}
        </div>
  ...
  return (
    <div className="sunday-home path-fade-in">
      <header className="sunday-home__header">
        ...
        <h1 className="path-display sunday-home__title">{formatSundayHeader(todayDateKey())}</h1>
      ...
      <div className="sunday-home__layout">
        <div className="sunday-home__main">
          {setup.isActive ? (
            <section className="sunday-home__success path-surface">
              ...
              <div className="sunday-home__success-actions">
                ...
                <Link className="path-btn path-btn--ghost" to={weekPlanPath(weekStart, 0)}>
                  Edit plan
                </Link>
              </div>
            </section>
          ...
          <section className="sunday-setup path-surface" aria-label="This week’s setup">
          ...
          {setup.isActive ? (
            <section className="sunday-week-summary path-surface">
